...
export function useChatBoxState() {
...
type MeshProviderProps = { //le provider pour pouvoir utiliser les refs dans les composants et les definir quand je veux
...
export const MeshProvider = ({ children }: MeshProviderProps) => {
	...
	//  Pour ajouter une ref:
	//               const newAboutUsRef = useRef<JSX.IntrinsicElements['mesh']>(null); pour definir
	//                  setMeshRefs(prevState => ({ ...prevState, AboutUS: newAboutUsRef }));
	//                      return <mesh ref={meshRefs.AboutUS} /> pour utiliser
