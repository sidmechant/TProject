...
import { MAP_HEIGHT } from '../../store/physic/constante';
...
export const AnimationSkillDesert: React.FC<{ isUltiUsed: boolean, refPaddle: React.RefObject<THREE.Group>, velocity: number }> = ({ isUltiUsed, refPaddle, velocity }) => {
...
//CustomEase.create("custom", "M0,0 C0,0 0.144,0.09 0.3,0.124 0.424,0.092 0.428,0.042 0.472,0 0.472,0.088 0.566,0.182 0.678,-0.01 0.678,0.09 0.758,0.062 0.82,0 0.848,0.032 1,0 1,0 ");